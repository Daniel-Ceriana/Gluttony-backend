...
<h1 style="color: white;font-family: monospace;"> Haz click<a style="text-decoration: none; color: gray; font-family:monospace;" href=http://localhost:4000/api/users/auth/verifyEmail/${uniqueString}> Aquí </a> para validar tu cuenta</h1>
