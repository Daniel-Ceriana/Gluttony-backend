...
<h1 style="color: white;font-family: monospace;"> Haz click<a style="text-decoration: none; color: gray; font-family:monospace;" ${process.env.APIROUTE}/api/auth/verifyEmail/${uniqueString}> Aquí </a> para validar tu cuenta</h1>
